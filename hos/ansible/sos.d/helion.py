...
import os
import os.path
from sos.plugins import Plugin, DebianPlugin, RedHatPlugin
...
class RedHatHelion(Helion, RedHatPlugin):
    """Helion related information for RedHat distributions
    """
