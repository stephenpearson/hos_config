...
from sos.plugins import Plugin, DebianPlugin, RedHatPlugin, UbuntuPlugin
...
class OpenStackIronic(Plugin):
    ...
    option_list = [("log", "gathers openstack ironic logs", "slow", True),
                   ("cmds", "gathers openstack ironic commands", "slow", False)]
